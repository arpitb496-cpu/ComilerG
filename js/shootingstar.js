if (typeof dat === 'undefined') {
  window.dat = {
    GUI: function() {
      this.add = function() { return { min: function() { return this; }, max: function() { return this; }, step: function() { return this; }, onChange: function() { return this; } }; };
      this.addColor = function() { return { onChange: function() { return this; } }; };
      this.addFolder = function() { return new window.dat.GUI(); };
      this.closed = true;
    }
  };
}
    ...
    value: function start() {
      ...
      $Zk$export$animate(function (progress) {
        _this2.shootingStar.draw({
          ...
          clientY: (progress * $mrfc$export$default.clientHeight - $mrfc$export$default.clientHalfHeight)
        });
      }, {
